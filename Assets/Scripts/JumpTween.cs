...
public class JumpTween : MonoBehaviour {
	[SerializeField] float jumpTimeFactor = 0.16f; // Jump time factor
	[SerializeField] float jumpHeightFactor = 0.4f;
	...
	void Awake () {
		sizeHeight = new Vector3(0, collider2D.bounds.size.y, 0);
